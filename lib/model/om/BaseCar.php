...
abstract class BaseCar extends BaseObject  implements Persistent {
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = CarPeer::USER_ID;
		}
	...
	public function setBrand($v)
	{
		...
		if ($this->brand !== $v) {
			$this->brand = $v;
			$this->modifiedColumns[] = CarPeer::BRAND;
		}
	...
	public function setModel($v)
	{
		...
		if ($this->model !== $v) {
			$this->model = $v;
			$this->modifiedColumns[] = CarPeer::MODEL;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = CarPeer::STATUS;
		}
	...
	public function setMileage($v)
	{
		...
		if ($this->mileage !== $v) {
			$this->mileage = $v;
			$this->modifiedColumns[] = CarPeer::MILEAGE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mileage = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			...
			return $startcol + 9; // 9 = CarPeer::NUM_COLUMNS - CarPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(CarPeer::UPDATED_AT))
			{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setMileage($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CarPeer::USER_ID)) $criteria->add(CarPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(CarPeer::BRAND)) $criteria->add(CarPeer::BRAND, $this->brand);
		if ($this->isColumnModified(CarPeer::MODEL)) $criteria->add(CarPeer::MODEL, $this->model);
		if ($this->isColumnModified(CarPeer::COLOR)) $criteria->add(CarPeer::COLOR, $this->color);
		if ($this->isColumnModified(CarPeer::STATUS)) $criteria->add(CarPeer::STATUS, $this->status);
		if ($this->isColumnModified(CarPeer::MILEAGE)) $criteria->add(CarPeer::MILEAGE, $this->mileage);
